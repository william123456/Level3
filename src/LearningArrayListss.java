	// Copyright League of Amazing Programmers 2013
	import java.util.ArrayList;

	import junit.framework.TestCase;
public class LearningArrayListss {


	/* Use the internet to figure out how to use ArrayLists. Try not to use auto-complete. */
